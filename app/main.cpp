...
LONG WINAPI UnhandledExceptionHandler(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    swprintf_s(dmpFileName, L"%ls\\tinyct-%I64u.dmp",
...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("TinyCt Project");
    QCoreApplication::setOrganizationDomain("tinyct.local");
    QCoreApplication::setApplicationName("tinyct");
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("tinyct-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("tinyct-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
    ...
    SDL_SetHint(SDL_HINT_AUDIO_DEVICE_APP_NAME, "tinyct");
    SDL_SetHint(SDL_HINT_APP_NAME, "tinyct");
    ...
    app.setWindowIcon(QIcon(":/res/tinyct.svg"));
#endif

    // This is necessary to show our icon correctly on Wayland
    app.setDesktopFileName("com.tinyct.TinyCt");
    qputenv("SDL_VIDEO_WAYLAND_WMCLASS", "com.tinyct.TinyCt");
    qputenv("SDL_VIDEO_X11_WMCLASS", "com.tinyct.TinyCt");
